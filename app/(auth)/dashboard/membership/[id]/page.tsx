"use client";
import { ArrowLeft, User, Mail, Phone, MapPin, Calendar, FileText, Users, CheckCircle, XCircle, Clock, Package, FileImage, X } from "lucide-react";
...
export default function MembershipRequestDetailsPage() {
  ...
  const handleApprove = () => {
    ...
    if (!confirm(`Are you sure you want to approve the application from "${application.name_english}"?`)) return;
    ...
    <>
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          ...
          >
            <ArrowLeft size={20} />
            <span className="text-[14px] font-medium">Back to My Sponsored Members</span>
          </button>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {application.nominees && application.nominees.length > 0 && (
              <div className="bg-white rounded-xl shadow border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  {application.nominees.map((nominee: any, index: number) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {documents.nid_front && (
                    <div className="space-y-2">
                      ...
                      <div
                        className="relative cursor-pointer rounded-lg overflow-hidden border-2 border-[#E5E7EB] hover:border-[#068847] transition-all bg-gray-100"
                  ...
                  {documents.signature && (
                    <div className="space-y-2">
                      ...
                      <div
                        className="relative cursor-pointer rounded-lg overflow-hidden border-2 border-[#E5E7EB] hover:border-[#068847] transition-all bg-white"
