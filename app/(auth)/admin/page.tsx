...
import { Users, FolderKanban, TrendingUp, Wallet, ArrowUpRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1">Welcome back! Here's what's happening at Expro Welfare Foundation today.</p>
      </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold text-gray-900 mt-2">৳8,42,000</h3>
            </div>
            <div className="p-2 bg-green-50 rounded-lg">
