...
// 1. Rename interface to be specific
interface ProjectTeamsRolesProps {
  setOpenModal?: React.Dispatch<React.SetStateAction<boolean>>; // Add this
...
export default function ProjectTeamsRoles({
  ...
  return (
    // 3. Apply the flex layout fix here too!
