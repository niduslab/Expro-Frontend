      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 md:p-12">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            You have cancelled the payment process. Your application is still
            saved and waiting for payment.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8 text-left">
            ...
            <ul className="space-y-2 text-sm text-blue-800">
              <li className="flex items-start">
                ...
                <span>
                  Your application has been saved and is waiting for payment
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
              ...
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  Your application will remain in "Payment Pending" status until
          ...
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm text-yellow-800">
              <strong>Note:</strong> You can complete the payment later by using
              the retry link sent to your email, or by contacting our support
              team with your application number.
            </p>
          </div>
