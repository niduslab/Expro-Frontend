    ...
    <>
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 ">
        <div className="font-dm-sans flex flex-col items-center bg-gray-50">
          <main className="container py-16 flex flex-col lg:flex-row gap-12">
            {/* Project Content */}
            <article className="flex-1 flex flex-col gap-8 bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 leading-relaxed text-base">
                The Community Skills Development & Empowerment Program is
                designed to equip individuals with practical, income-generating
                skills that foster independence and long-term sustainability.
                This initiative focuses on vocational training, entrepreneurship
                development, and financial literacy to uplift underserved
                communities.
              </p>
              ...
              <section className="flex flex-col gap-4">
                ...
                <p className="text-gray-700 leading-relaxed text-base">
                  This project addresses unemployment and economic instability
                  by providing structured training programs and mentorship
                  opportunities. Participants gain hands-on experience in
                  high-demand skills, along with guidance on starting and
