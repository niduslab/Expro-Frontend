  ...
  return (
    <>
      <div className="container mx-auto px-6 md:px-12 lg:px-20 ">
        {/* Director 1 */}
        <section className="font-dm-sans  pb-16 lg:pb-[120px]">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            {/* Image */}
            <div className="relative w-full lg:w-1/2 h-[320px] sm:h-[420px] lg:h-[675px] bg-[#F3F4F6] rounded-lg overflow-hidden">
              <Image
            ...
            {/* Content */}
            <div className="container lg:w-1/2 flex flex-col items-start justify-center gap-6">
              ...
              <p className="text-sm sm:text-base text-gray-600 font-dm-sans leading-relaxed text-justify">
                ...
                horizon of financial security has been opened for the middle-
                and lower-income people of Bangladesh.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="font-dm-sans  pb-16 lg:pb-[120px]">
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-start justify-center gap-6">
              ...
              <p className="text-sm sm:text-base text-gray-600 font-dm-sans leading-relaxed text-justify">
                Through its pension project, Expro Welfare Foundation will play
                a significant role in improving the socio-economic condition of
                ordinary people.
              </p>
            </div>
