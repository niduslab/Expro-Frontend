export default function CoreFocusArea() {
  return (
    <>
      <div className="h-[654px] px-[64px] py-[64px]  flex flex-col items-center justify-center gap-[60px]">
        ...
        <div className="bg-[#F9FAFB] h-[248px] gap-[24px] p-[24px] rounded-[8px] grid grid-cols-4">
          <div className="flex flex-col items-start gap-6 w-[310px]">
            ...
            <div className="h-[99px] space-y-3">
              ...
              <p className="font-dmSans font-normal text-[17px] leading-[1.5] tracking-[-0.01em] text-[#4A5565]">
