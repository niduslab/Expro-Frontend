        ...
        <div className="text-center">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8 text-left">
            ...
            <ul className="space-y-2 text-sm text-blue-800">
              ...
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>Your membership ID will be sent to your registered email</span>
              </li>
              {paymentStatus !== 'success' && (
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span className="font-semibold">Please complete your payment to activate your membership</span>
                </li>
              )}
            </ul>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-sm text-gray-500">
              ...
              {' '}or call{' '}
              <a href="tel:+8801234567890" className="text-[#008543] hover:underline">
                +880 1234-567890
              </a>
            </p>
          </div>
