...
export default function BlogItems2() {
      ...
      <div className="mt-6 space-y-4">
        <div className="space-y-3">
          <h3 className="text-xl font-semibold text-gray-900 leading-tight">
            Why Pension Security Matters for a Stable Future
          </h3>

          <p className="text-gray-600 text-sm leading-relaxed">
            Explore the importance of pension-based financial security and how
            structured...
          </p>
        </div>
