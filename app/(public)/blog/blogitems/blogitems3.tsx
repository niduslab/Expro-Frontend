...
export default function BlogItems3() {
      ...
      <div className="mt-6 space-y-4">
        <div className="space-y-3">
          <h3 className="text-xl font-semibold text-gray-900 leading-tight">
            Women Empowerment: Building Stronger Societies Together
          </h3>

          <p className="text-gray-600 text-sm leading-relaxed">
            Learn how empowering women through education, entrepreneurship, and
            equal...
          </p>
        </div>
