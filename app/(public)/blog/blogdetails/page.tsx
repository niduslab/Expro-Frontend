    ...
    <>
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 ">
        <div className="flex flex-col items-center bg-gray-50">
          <main className="py-16 flex flex-col lg:flex-row gap-12">
            {/* Blog Content */}
            <article className="flex-1 flex flex-col gap-8 bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="font-dm-sans text-gray-700 leading-relaxed text-base">
                ...
                become self-reliant, resilient, and future-ready. At Expro
                Welfare Foundation, true development happens when people are
                equipped with the tools, knowledge, and support they need to
              ...
              <section className="flex flex-col gap-4">
                ...
                <p className="font-dm-sans text-gray-700 leading-relaxed text-base">
                  ...
                  pension-based systems play a critical role in ensuring
