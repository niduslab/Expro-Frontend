...
export function CtaSection() {
  return (
    <section className=" py-16 md:py-20 bg-white flex justify-center">
      <div className="relative  max-w-362.5 min-h-119 mx-auto rounded-2xl overflow-hidden flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-12 bg-[#00341C]/12">
        {/* Background Image */}
