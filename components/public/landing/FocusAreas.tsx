...
const areas = [
  {
    ...
    description:
      "Delivering quality education for community advancement and personal growth.",
    icon: BookOpen,
  },
  {
    title: "Human Rights",
    description:
      "Providing services for social improvement and protecting human rights of all.",
    icon: Scale,
  },
  {
    title: "Women Empowerment",
    description:
      "Ensuring active participation of women in society and economic activities.",
    icon: Users,
  },
  {
    title: "Sustainable Development",
    description:
      "Creating lasting positive change through sustainable development practices.",
    icon: Leaf,
  },
  {
    title: "Technology Transfer",
    description:
      "Introducing modern technologies to boost productivity and efficiency.",
    icon: Cpu,
  },
  {
    title: "Good Governance",
    description:
      "Establishing transparent and accountable governance in all operations.",
    icon: BadgeCheck,
  },
  {
    title: "Capacity Building",
    description:
      "Enhancing skills and capabilities through comprehensive training programs.",
    icon: GraduationCap,
  },
  {
    title: "Poverty Reduction",
    description:
      "Fighting poverty through microfinance and sustainable livelihood programs.",
    icon: HandCoins,
  },
];
...
const FocusAreas = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="font-dm-sans relative py-20 bg-[#0B2F1C] text-white overflow-hidden"
    >
        ...
        >
          {areas.map((area) => (
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-[#CBE8D7]">
                {area.description}
              </p>
            </div>
          ))}
