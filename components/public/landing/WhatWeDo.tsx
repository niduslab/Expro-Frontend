...
const services = [
  {
    ...
    image:
      "/images/landing-page/what-we-do/17b349fa401e7df876b2e86aa904075458e5a936.jpg",
    icon: Heart,
  ...
  },
  {
    ...
    image:
      "/images/landing-page/what-we-do/3cbfda320dd7781e80fffe9dac1be01f5699a106.jpg",
    icon: GraduationCap,
    link: "projects/project-details",
  },
  {
    ...
    image:
      "/images/landing-page/what-we-do/a4385f1e3bcee3ee1243d95f6f7be44aaff692d7.jpg",
    icon: Sprout,
    link: "projects/project-details",
  },
  {
    ...
    description:
      "Providing accessible healthcare services, medical camps, and health awareness programs to underserved communities.",
    image:
      "/images/landing-page/what-we-do/c20153c681270ed346be602a6c69559deb80cd8d.jpg",
    icon: Users,
    link: "projects/project-details",
  },
  {
    ...
    image:
      "/images/landing-page/what-we-do/0e90e9e34e7a5e331dfff3d6c7a8c62f74d206c7.jpg",
    icon: HandHeart,
    link: "projects/project-details",
  },
  {
    ...
    image:
      "/images/landing-page/what-we-do/f6c746f7a4e082fda48cd73ea70537c916c0cd3c.jpg",
    icon: Tv,
    link: "projects/project-details",
  },
];
...
const WhatWeDo = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const button = sectionRef.current?.querySelector(
        "[data-whatwedo-button]",
      );
  ...
  const { data, isLoading, error } = useProjects(1, 6);
