...
const WhoWeAre = () => {
  ...
  const textSegments = [
    {
      text: "Expro Welfare Foundation",
      className: "font-playfair-display italic text-[#008A4B] font-bold",
    },
    {
      text: " is a welfare-focused organization committed to empowering communities through sustainable initiatives, transparent governance, and long-term financial security programs. Our mission is to support individuals with structured welfare services and ",
      className: "font-dm-sans text-gray-900",
    },
    {
      text: "pension solutions that promote stability, dignity, and shared progress.",
      className: "font-playfair-display italic text-[#667085]",
    },
  ];
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        <div className="mx-auto">
          ...
          <div data-who-button className="mb-16">
            <Link href="/about">
              <Button className="inline-block px-8 py-3 cursor-pointer bg-green-700 hover:bg-green-800 text-white font-semibold rounded-lg transition-colors duration-300 shadow-sm hover:shadow-md">
                More About Us
              </Button>
            </Link>
          </div>
          ...
          >
            ...
            <div
              data-who-stat
              className="bg-[#F0F4F2]  h-48.75 p-8 rounded-lg border border-gray-200 hover:shadow-md transition-shadow duration-300 flex flex-col justify-center"
            >
