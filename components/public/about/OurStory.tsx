...
const OurStory = () => {
  return (
    <section className="py-16 md:py-24 bg-white overflow-hidden font-dm-sans ">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-600 font-dm-sans leading-relaxed text-[14px] md:text-[16px] text-justify">
              <p>
                ...
                that address root causes of problems. Now it has been
                implemented a number of development programs and projects to
                bring out sustainable development of vulnerable, disadvantaged
                and underprivileged people of the northern parts of the country.
              </p>
              ...
              <p>
                ...
                Welfare Foundation (EWF) strengthened its activities and
                included more intervention like institution building, income and
                employment generating activities, Environment, water &
                sanitation, agriculture, educational activities, fashion design,
                woman entrepreneurship, tailoring tanning, markets and
                livelihoods program & food- processing etc. and expanded its
                area of operation simultaneously. To implementing all over the
                programs EWF always considering the poverty alleviation issue
                specially entrepreneurship development and take necessary action
                to successful implementation of the program. EWF is implementing
                its development activities through All Upazila under Bogura
                district then all over Bangladesh.
              </p>
            </div>
          </div>
        </div>
