...
const OurFounder = () => {
  ...
  // 2. No Live Data — fall back to static founder content
  if (!founderMember) {
    return (
      <section className="font-dm-sans py-12 md:py-16 lg:py-20 bg-white overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 md:px-10 lg:px-16">
            ...
            <div className="space-y-5 md:space-y-6 order-2 lg:order-1 px-2 md:px-2">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed text-sm sm:text-[15px] md:text-base">
                ...
                <p className="text-justify">
                  ...
                  Principal by profession, he has dedicated his life to
                  education, character building and the empowerment of the youth.
                </p>
                ...
                <p className="text-justify">
                  Social and Economic Impact — Driven by a deep sense of
                  patriotism, he established the{" "}
                  <span className="font-bold text-gray-900">
                    Expro Welfare Foundation
                  </span>{" "}
                  to bridge the gap between education and economic growth. Under
                  his leadership, Expro foundation continues to strive for a
