      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((value, index) => (
            <div
              key={index}
              className="group flex flex-col items-center hover:bg-slate-100 justify-center p-8 rounded-xl border border-gray-300 transition-all duration-300 min-h-45 bg-white hover:border-[#36F293]/30 hover:shadow-[0_4px_20px_rgba(54,242,147,0.1)]"
            >
