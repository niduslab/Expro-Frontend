  ...
  const items = [
    {
      ...
      title: "Our Mission",
      description:
        "To create self-sufficient, self-employed and self-empowered communities through increasing capabilities by providing need based supports like awareness raising, Agriculture, Educational Activities, Fashion Design, Woman entrepreneurship, Tailoring tanning, Markets and Livelihoods Program & food processing etc.",
    },
    {
      icon: Eye,
      title: "Our Vision",
      description:
        "We expect a society where established human rights and social justice and ensured self-sufficiency of the community.",
    },
    {
      icon: Flag,
      title: "Our Goal",
